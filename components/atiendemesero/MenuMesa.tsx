      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="bg-gray-800/95 backdrop-blur-md shadow-xl p-4 border-b border-gray-700">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-white">Mesa {mesaNumero}</h1>
              <p className="text-sm text-blue-400 font-medium">🍽️ Pedido para consumir en el local</p>
            </div>
            <button
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                      ...
                      <button
                        ...
                        className="w-8 h-8 bg-blue-600 rounded-full hover:bg-blue-500 transition font-bold text-white"
                      >
                        +
                      </button>
                    </div>
